...
export default {
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        mobile: [{ required: true, trigger: 'blur', message: '手机号不为空' }, { trigger: 'blur', validator: validateMobile }],
        password: [{ required: true, trigger: 'blur', message: '密码不能为空' }, { trigger: 'blur', max: 26, min: 6, message: '密码长度在6-10' }]
      },
      loading: false,
